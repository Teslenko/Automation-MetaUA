...
public class AutomationQaMetaUa {
    ...
    public void LoginFormVerification() throws InterruptedException {
        $(By.name("login")).val("TeslQA");                                          //Input in Login field
        $(By.name("lifetime")).click();                         Thread.sleep(1000); //Click checkbox "remember"
        $(By.name("lifetime")).click();                         Thread.sleep(1000); //Click checkbox "remember"
    ...
    public void SwitchInternetTab() throws InterruptedException, AWTException {
        ...
        $(By.id("s-dir")).contextClick();                   Thread.sleep(700);  //Press for Directory tab "right button mouse"
